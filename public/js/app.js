...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    editItem: function editItem(id) {
      ...
      this.axios.get(uri).then(function (response) {
        if (response.data.status == '1') {
          _this3.addEditHeader = 'Edit User';
          _this3.id = response.data.item.id;
          _this3.name = response.data.item.name;
          _this3.email = response.data.item.email;
        } else {
          alert(response.data.message);
        }
      });
    ...
    deleteItem: function deleteItem(id, index) {
      ...
      if (confirm("Do you really want to delete?")) {
        var uri = "users/delete/".concat(id);
...
vue__WEBPACK_IMPORTED_MODULE_0__.default.use((vue_axios__WEBPACK_IMPORTED_MODULE_2___default()), (axios__WEBPACK_IMPORTED_MODULE_3___default())); //moment for date formatting
...
vue__WEBPACK_IMPORTED_MODULE_0__.default.router = router; //Import main component

 //Register Main Component

new vue__WEBPACK_IMPORTED_MODULE_0__.default(vue__WEBPACK_IMPORTED_MODULE_0__.default.util.extend({
  router: router
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("p", [
      _c("span", [_vm._v(_vm._s(_vm.addEditHeader))]),
      _vm._v(" "),
      _c("span", { staticClass: "float-right" }, [_vm._v("By: awais")])
    ]),
    _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "col-md-8" }, [
      _c("h1", [_c("u", [_vm._v("'My Awesome List'")])])
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _c("td", [_vm._v("Email")]),
        _vm._v(" "),
        _c("td", { attrs: { colspan: "1" } }, [_vm._v("Actions")])
      ])
    ])
  }
]
